<script>
  ...
  import { users, activityUserLogs as allLogs } from "$data/riwayatData.js";
...
<section class="">
  ...
  <div class="relative flex flex-col lg:flex-row">
    <LogCard
      logs={filteredLogs}
      emptyMessage="Tidak ada riwayat aktivitas yang ditemukan."
    />
    <div
