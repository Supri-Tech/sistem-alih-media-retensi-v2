<script>
  ...
  import { users, transactionLogs as allLogs } from "$data/riwayatData.js";
  ...
  function getBorderColor(status) {
    return status === "inactive" ? "border-red-500" : "border-emerald-500";
  }
</script>
  ...
  <div class="border-y border-gray-300 p-3">
    <p class="font-medium text-gray-700">
      Riwayat <span class="text-emerald-700 font-semibold"
        >transaksi dokumen</span
      >
      seperti pengajuan, pencetakan, dan penghapusan arsip dokumen penting.
    </p>
  </div>
