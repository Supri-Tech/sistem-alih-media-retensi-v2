<script>
  ...
  const idFromUrlParams = urlParams.get("id");

  if (idFromUrlParams) nomorRM = idFromUrlParams;

  // Update field pasien saat pilih RM
  $: if (nomorRM) {
  ...
  function tambahDokumen() {
    // Buka file input secara manual jika ingin satu-satu
